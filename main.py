...
def send_whatsapp_alert(title, read_time, topic):
    ...
    url = f"[https://api.textmebot.com/send.php?recipient=](https://api.textmebot.com/send.php?recipient=){WHATSAPP_PHONE_NUMBER}&apikey={TEXTMEBOT_API_KEY}&text={encoded}"
...
def get_featured_image(topic):
    ...
    clean_image_url = f"https://image.pollinations.ai/prompt/{prompt_encoded}?width=800&height=450&nologo=true"
